...
monthly_df = pd.read_csv("./dataset/monthly.csv")
quarter_df = pd.read_csv("dataset/quarter.csv")
cluster_df = pd.read_csv("./dataset/cluster.csv")
season_df = pd.read_csv("./dataset/season.csv")
weathersit_df = pd.read_csv("./dataset/weathersit.csv")
